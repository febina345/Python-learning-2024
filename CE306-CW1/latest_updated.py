...
index_mapping_5 = {
    "settings": {
        "analysis": {
            "tokenizer": {
                "standard_tokenizer": {
                    "type": "standard"  # Standard tokenizer for word-based tokenization
                }
            },
            "filter": {
                "stop_filter": {
                    "type": "stop",
                    "stopwords": "_english_"  # This will load a predefined list of English stopwords
                },
                "stemmer_filter": {
                    "type": "stemmer",
                    "name": "english"  # Use the English stemmer
                }
            },
            "analyzer": {
                "custom_analyzer": {
...
response = es.indices.create(index="articles_index5", body=index_mapping_5, ignore=400)
