...
for doc in articles:
    action = {
        ...
        "_source": {
            ...
            "travel_companion": [
                {"companion": doc.get("travel_companion.1")},
                {"companion": doc.get("travel_companion.2")},
                {"companion": doc.get("travel_companion.3")},
                {"companion": doc.get("travel_companion.4")},
                {"companion": doc.get("travel_companion.5")}
            ]
        }
    }
